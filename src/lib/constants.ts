...
export const TICKET_REASONS = [
  ...
  { value: "Bloqueio temporário COL (erro de acesso)", label: "Bloqueio temporário COL (erro de acesso)", responseTime: "1 dia útil", is_active: true },
  ...
  { value: "Erros no APP do consórcio", label: "Erros no APP do consórcio", responseTime: "5 dias úteis", is_active: true },
...
export const TICKET_STATUSES: TicketStatus[] = ["Novo", "Em Andamento", "Ativo", "Atrasado", "Porto Resolve", "Suporte", "Concluído"];
