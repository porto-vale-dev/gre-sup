...
const allServices: Service[] = [
    ...
    { title: "Novo ticket - GRE", href: "/suporte-gre", Icon: Ticket, description: "Abra um novo ticket de suporte para o GRE.", allowedRoles: ["adm", "diretor", "gerente", "colaborador", "greadmin", "gre"] },
