...
import { ArchivedComprasTicketsClient } from "@/components/ArchivedComprasTicketsClient";
...
export default function ArchivedComprasPage() {
  const { cargo } = useAuth();
